    ...
    <Section className="bg-paper-dim/60">
      <Reveal className="mx-auto max-w-3xl">
        ...
        <div className="text-ink-soft mt-5 space-y-4 text-[0.95rem] leading-relaxed">
          ...
          <p>
            Для печати используем плотный хлопок 180–240 г/м² и профессиональные
            краски. Цвета остаются яркими и насыщенными надолго, принт не
            трескается и не выцветает при бережной стирке. Перед запуском вы
            бесплатно получаете макет на согласование — никаких сюрпризов в
            результате.
          </p>
          <p>
